...
import { selectedThumbs, selectedFull, site } from "../data/images";
...
export default function Selected() {
  ...
  const addThumbRef = collect(thumbRefs);
      ...
      <div className="flex flex-col">
        ...
        >
          ...
          <div className="w-6/12 flex justify-between overflow-hidden">
            <div className="invisible" ref={addHeaderRef}>
              <Link href="/" className="headerLink hidden md:block">Overview</Link>
            </div>
            <div className="invisible" ref={addHeaderRef}>
              <Link href="/selected" className="underline">Selected</Link>
            </div>
            <div className="invisible" ref={addHeaderRef}>
