...
// - pannello nero "slidee" che sale da sotto: y 100vh -> 0 in 1s, stessa ease
...
export default function Layout({ children }) {
  return (
    <div className="innerr bg-white">
      <motion.div
        style={{ zIndex: 12000 }}
        className="slidee h-screen w-full fixed left-0 top-0 bg-white"
        {...anim(slideVariants)}
      />
